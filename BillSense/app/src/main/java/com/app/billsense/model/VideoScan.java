...
/**
 * The definitive and correct model class for parsing the detailed video scan report from Firebase.
 * This class matches the JSON structure provided on 2025-11-26, correcting previous data type mismatches.
 */
@IgnoreExtraProperties // This is crucial for ignoring duplicate/extra fields in Firebase like 'genuine' and 'highDenomination'.
public class VideoScan {
    ...
    private List<String> numberMapping; // CORRECTED: It is a List<String> in the JSON
    ...
    public List<String> getNumberMapping() { return numberMapping; } // CORRECTED
    public void setNumberMapping(List<String> numberMapping) { this.numberMapping = numberMapping; } // CORRECTED
    ...
    public void setFramesProcessed(int framesProcessed) { this.framesProcessed = framesProcessed; }

    public long getBestConfidence() { return bestConfidence; }
    public void setBestConfidence(long bestConfidence) { this.bestConfidence = bestConfidence; }
    ...
    public static class Authenticity {
        ...
        private List<String> reasons; // CORRECTED: It is a List<String> in this JSON
        private String status;
        private int totalExpectedFeatures;
        ...
        public List<String> getReasons() { return reasons; } // CORRECTED
        public void setReasons(List<String> reasons) { this.reasons = reasons; } // CORRECTED
        public String getStatus() { return status; }
        public void setStatus(String status) { this.status = status; }
        public int getTotalExpectedFeatures() { return totalExpectedFeatures; }
        public void setTotalExpectedFeatures(int totalExpectedFeatures) { this.totalExpectedFeatures = totalExpectedFeatures; }
    ...
    public static class QualityMetrics {
        ...
        // Note: brightnessScore and contrastScore are missing in the video JSON, @IgnoreExtraProperties handles this.
